	...
	**/
	...
	var vueisotope = {
	    ...
	    render: function render(h) {
	        ...
	        rawChildren.forEach(function (elt) { return addClass(elt, this$1.itemSelector); });
	        ...
	        if (prevChildren) {
	            for (var i$1 = 0; i$1 < prevChildren.length; i$1++) {
	                ...
	                if (!map[c$1.key]) {
	                    displayChildren.splice(i$1, 0, c$1);
	                    removedKeys.push(c$1.key);
	                }
	            }
	        }
	    ...
	    mounted: function mounted() {
	        ...
	        var update = function (object) {
	            Object.entries(object).forEach(function (ref) {
	                ...
	                object[key] = function (itemElement) { var res = getItemVm(itemElement); return value.call(this$1, res.vm, res.index); };
	            });
	        };
	        ...
	        this.$nextTick(function () {
	            this$1.link();
	            this$1.listen();
	            var iso = new isotope(this$1.$el, options);
	    ...
	    beforeDestroy: function beforeDestroy() {
	        this._listeners.forEach(function (unlisten) { unlisten(); });
	    ...
	    updated: function updated() {
	        ...
	        var newChildren = Array.from(this.$el.children);
	        var added = newChildren.filter(function (c) { return !this$1._oldChidren.includes(c); });
	        var removed = this.removedKeys.map(function (key) { return Array.from(this$1.$el.children).find(function (c) { return c.__vue__.$vnode.key === key; }); });
	    ...
	    methods: {
	        cleanupNodes: function cleanupNodes() {
	            ...
	            this._vnode.children = this._vnode.children.filter(function (c) { return !this$1.removedKeys.includes(c.key); });
	            this.$children = this.$children.filter(function (c) { return !this$1.removedKeys.includes(c.$vnode.key); });
	        },
	        ...
	        link: function link() {
	            ...
	            slots.forEach(
	                function (slot, index) {
	                    var elmt = slot.elm;
	                    if (elmt)
	                        { elmt.__underlying_element = { vm: this$1.list[index], index: index }; }
	                });
	        },
	        ...
	        listen: function listen() {
	            ...
	            this._listeners = Object.values(this.compiledOptions.getSortData).map(function (sort) {
	                return Array.from(this$1.$el.children).map(function (collectionElement, index) {
	                    return this$1.$watch(function () { return sort(collectionElement); }, function () {
	                        this$1.iso.updateSortData();
	                        this$1.iso._requestUpdate();
	                    });
	                });
	            }).flat();
	        },
	        ...
	        buildFilterFunction: function buildFilterFunction(name) {
	            ...
	            this._filterlistener = this.$watch(function () { return this$1.list.map(function (el, index) { return this$1.options.getFilterData[name](el, index); }); },
	                function () { this$1.iso._requestUpdate(); });
	            return filter
	        },
	        ...
	        unfilter: function unfilter() {
	            this.arrange({ filter: function () { return true; } });
	    ...
	    computed: {
	        compiledOptions: function compiledOptions() {
	            ...
	            Object.entries(options.getSortData).forEach(function (ref) {
	                var key = ref[0];
	                var value = ref[1];

	                if (typeof value === "string")
	                    { options.getSortData[key] = function (itemElement) { return itemElement[value]; }; }
	            });
